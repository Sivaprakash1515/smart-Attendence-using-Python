...
def check_haarcascadefile():
    exists = os.path.isfile("Algorithm.xml")
    if exists:
        pass
    else:
...
message3 = tk.Label(window, text="640-SMART ATTENDANCE SYSTEM" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
